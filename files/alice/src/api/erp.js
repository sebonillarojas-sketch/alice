...
export const erpTasks = {
  ...
  create: (task, userId) => erpFetch("POST", "/api/tasks", {
    ...
    assignees:   (Array.isArray(task.assignees) && task.assignees.length) ? task.assignees : (task.assignee ? [task.assignee] : []),
...
export function erpTaskToCockpit(t) {
  ...
  return {
    ...
    assignees:  (Array.isArray(t.assignees) && t.assignees.length) ? t.assignees : (t.assignee_id ? [t.assignee_id] : []),
