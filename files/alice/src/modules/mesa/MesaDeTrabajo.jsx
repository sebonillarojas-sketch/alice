...
const DEF = {
  titulo: "Mesa de trabajo — San Antonio 02",
  sesion: "Sesión 01",
  fecha: "23.10.2026",
  showGrid: true,
...
export default function MesaDeTrabajo() {
  ...
  return (
    <div ref={wrapRef} style={{ width: "100%", height: "calc(100vh - 108px)", overflow: "auto", background: "#D6D4D0" }}>
      <style>{`.mesa-nota:hover .mesa-nota-x{opacity:.6}.mesa-nota .mesa-nota-x:hover{opacity:1}`}</style>

      {/* barra de la app: grid + zoom */}
      <div style={{ position: "sticky", top: 0, left: 0, zIndex: 20, display: "flex", gap: 8, alignItems: "center", padding: "8px 16px", background: BG, borderBottom: `1px solid ${INK}` }}>
      ...
      <div style={{ width: BOARD_W * scale, height: BOARD_H * scale, margin: "16px auto" }}>
        <div ref={boardRef} data-screen-label="Mesa de trabajo"
          ...
          <header style={{ position: "relative", display: "flex", alignItems: "baseline", gap: 32, padding: "36px 60px 28px", borderBottom: `1px solid ${INK}` }}>
            <img src="/bam-logo.png" alt="BAM" style={{ width: 120, display: "block", alignSelf: "center" }} />
